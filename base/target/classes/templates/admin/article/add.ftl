...
<title>${siteName!""}|文章管理-添加文章</title>
    ...
    <main class="lyear-layout-content">
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="card">
              <div class="card-header"><h4>添加文章</h4></div>
              <div class="card-body">
                <form action="add" id="article-add-form" method="post" class="row">
                  ...
                  <div class="input-group m-b-10">
                    ...
                    <input type="text" class="form-control required" id="title" name="title" value="" placeholder="请输入文章名" tips="请填写文章名" />
                  </div>
    
                  <div class="input-group m-b-10">
                    <span class="input-group-addon">作者</span>
                    <select name="user.id" class="form-control" id="user">
                    	<#list users as user>
                  ...
                  <div class="input-group m-b-10">
                    ...
                    <input type="tel" class="form-control" id="contents" name="contents" value="" />
                  </div>
	...
	$("#add-form-submit-btn").click(function(){
		...
		$.ajax({
			...
			success:function(data){
				if(data.code == 0){
					showSuccessMsg('文章添加成功!',function(){
